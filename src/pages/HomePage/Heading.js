  ...
  return(
      ...
      <Grid data-aos="zoom-out"  spacing={2} sx={{ paddingTop: '130px', marginBottom: '49px'}} position="relative" display="flex" >
        <Grid container sm={1.5} >
          ...
          <Box component="a" marginBottom='5px' href={"https://discord.gg/dzjkkBfxug"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#3b3b3b", borderRadius : "50%", padding : '10px'}}>
              <Box  component="img"  src={"my_public/images/github.png"}/>
            </Box>
            <Box component="a"  marginBottom='5px' href={"https://twitter.com/Megacapitals"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#3b3b3b", borderRadius : "50%", padding : '10px' }} >
              <Box  component="img" src={"my_public/images/twitter (2).png"}/>
            </Box>
            <Box component="a"  marginBottom='5px' href={"https://t.me/MegacapitalVC"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#3b3b3b", borderRadius : "50%", padding : '10px' }} >
              <Box  component="img" src={"my_public/images/paper-plane.png"}/>
            </Box>
            <Box component="a"  marginBottom='5px' href={"https://medium.com/@megacapital.io"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#3b3b3b", borderRadius : "50%", padding : '10px' }} >
              <Box  component="img" src={"my_public/images/medium (2).png"}/>
            </Box>
            <Box component="a"  marginBottom='5px' href={"https://megacapital-io.gitbook.io/megacapital.io"} alignItems="center" sx={{width: 42, height: 42, bgcolor : "#3b3b3b", borderRadius : "50%", padding : '10px' }} >
              <Box  component="img" src={"my_public/images/book.png"}/>
            </Box>
          </Grid>
        </Grid>
